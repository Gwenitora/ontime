...
export default function RundownGroup({ data, hasCursor, collapsed, onCollapse }: RundownGroupProps) {
  ...
  const { selectedEvents, setSelectedGroup } = useEventSelection();
    ...
    >
      ...
      <div className={style.header}>
        <div className={style.titleRow}>
          <TitleEditor title={data.title} eventId={data.id} placeholder='Group title' />
